...
links.Timeline.prototype.setOptions = function(options) {
	...
	//localize the dateformat names for months and days from timeline language files
	dateFormat.i18n.dayNames = this.options.DAYS_SHORT.concat(this.options.DAYS);
	dateFormat.i18n.monthNames = this.options.MONTHS_SHORT.concat(this.options.MONTHS);
    }
...
links.Timeline.StepDate.prototype.getLabelMinor = function(options, date) {
    ...
    switch (this.scale) {
        ...
        case links.Timeline.StepDate.SCALE.SECOND:	return String(dateFormat(date,options.DATEFORMAT_MINOR_LABEL_SECOND));
        case links.Timeline.StepDate.SCALE.MINUTE:	return String(dateFormat(date,options.DATEFORMAT_MINOR_LABEL_MINUTE));
        case links.Timeline.StepDate.SCALE.HOUR:	return String(dateFormat(date,options.DATEFORMAT_MINOR_LABEL_HOUR));
        case links.Timeline.StepDate.SCALE.WEEKDAY:	return String(dateFormat(date,options.DATEFORMAT_MINOR_LABEL_WEEKDAY));
        case links.Timeline.StepDate.SCALE.DAY:		return String(dateFormat(date,options.DATEFORMAT_MINOR_LABEL_DAY));
        case links.Timeline.StepDate.SCALE.MONTH:	return String(dateFormat(date,options.DATEFORMAT_MINOR_LABEL_MONTH));
        case links.Timeline.StepDate.SCALE.YEAR:	return String(dateFormat(date,options.DATEFORMAT_MINOR_LABEL_YEAR));
        default:					return "";
    }
};
...
links.Timeline.StepDate.prototype.getLabelMajor = function(options, date) {
    ...
    switch (this.scale) {
        case links.Timeline.StepDate.SCALE.MILLISECOND:
	    return String(dateFormat(date,options.DATEFORMAT_MAJOR_LABEL_MILLISECOND));
        case links.Timeline.StepDate.SCALE.SECOND:
	    return String(dateFormat(date,options.DATEFORMAT_MAJOR_LABEL_SECOND));
        case links.Timeline.StepDate.SCALE.MINUTE:
	    return String(dateFormat(date,options.DATEFORMAT_MAJOR_LABEL_MINUTE));
        case links.Timeline.StepDate.SCALE.HOUR:
	    return String(dateFormat(date,options.DATEFORMAT_MAJOR_LABEL_HOUR));
        case links.Timeline.StepDate.SCALE.WEEKDAY:
        case links.Timeline.StepDate.SCALE.DAY:
	    return !isNaN(date) ? String(dateFormat(date,options.DATEFORMAT_MAJOR_LABEL_DAY)): "";
        case links.Timeline.StepDate.SCALE.MONTH:
            return String(dateFormat(date,options.DATEFORMAT_MAJOR_LABEL_MONTH));
        default:
            return "";
    }
};
